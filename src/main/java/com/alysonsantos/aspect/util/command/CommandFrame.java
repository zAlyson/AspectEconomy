package com.alysonsantos.aspect.util.command;

import com.alysonsantos.aspect.util.command.annotations.Command;
import com.alysonsantos.aspect.util.command.annotations.Completer;
import com.alysonsantos.aspect.util.command.argument.ArgumentType;
import com.alysonsantos.aspect.util.command.argument.ArgumentValidationRule;
import com.alysonsantos.aspect.util.command.result.ResultType;
